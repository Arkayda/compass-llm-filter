...
РФ, API-ключи и токены заменяются правдоподобными подстановками. Модель пишет
естественный ответ, в котором подстановки автоматически меняются на оригиналы
...
(встроенные и свои), песочница и журнал аудита. Управляющий API (`/v1/*`) не
имеет аутентификации — держите его внутри сети.
