...
└── tests/                             # 103 автоматических теста (pytest)
...
Проект покрыт 103 автоматическими тестами:
...
- `tests/test_proxy.py` (33 теста): интеграция FastAPI, SSE-потоки, CSP-заголовки, CSRF-защита, rate-limiting, очистка ошибок.
